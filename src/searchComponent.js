...
class ProductCategoryRow extends React.Component {
  ...
  const PRODUCTS = [
    ...
    {category: 'Electronics', price: '$399.99', stocked: false, name: 'iPhone 5',id:7},
    {category: 'Electronics', price: '$399.99', stocked: false, name: 'iPhone 5',id:8},
    {category: 'Electronics', price: '$399.99', stocked: false, name: 'iPhone 5',id:9}
  ];
